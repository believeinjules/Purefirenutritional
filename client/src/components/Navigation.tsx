      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="/">
              <a className="text-white font-medium px-4 py-2 rounded transition-all duration-200 hover:[text-shadow:0_0_6px_rgba(154,78,30,0.9)] hover:underline hover:underline-offset-4">
                Home
              </a>
            </Link>
            <Link href="/products">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/dashboard">
              <a className="text-white transition-all hover:drop-shadow-[0_0_8px_rgba(154,78,30,0.8)]">
                <User className="h-6 w-6" />
              </a>
            </Link>
            
            <Link href="/wishlist">
              <a className="text-white transition-all hover:drop-shadow-[0_0_8px_rgba(154,78,30,0.8)] relative">
            ...
            <button
              ...
              className="md:hidden text-white transition-all hover:drop-shadow-[0_0_8px_rgba(154,78,30,0.8)]"
            >
        ...
        {isMenuOpen && (
          <div className="md:hidden pb-4 space-y-2">
            <Link href="/">
              <a className="block text-white font-medium transition-all py-2 hover:[text-shadow:0_0_6px_rgba(154,78,30,0.9)] hover:underline hover:underline-offset-4">
                Home
              </a>
            </Link>
            <Link href="/products">
